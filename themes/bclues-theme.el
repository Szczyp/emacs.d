...
(custom-theme-set-faces
 ...
 '(linum                               ((t (:foreground "#99ccee"  :background "#222232" :height 100                                   ))))
 '(minibuffer-prompt                   ((t (:foreground "#1278A8"  :background nil       :weight bold                                  ))))
 '(escape-glyph                        ((t (:foreground "orange"   :background nil                                                     ))))
 '(highlight                           ((t (                       :background "#222232"                                               ))))
 ...
 '(mode-line                           ((t (:foreground "#99ccee"  :background "#222232" :font "Envy Code R" :box nil :height 130 :inherit (variable-pitch) ))))
